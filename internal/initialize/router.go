...
func InitRouter() *gin.Engine {
	...
	if global.Config.Server.Mode == "dev" {
		...
		gin.ForceConsoleColor()    // In ra màu sắc cho dễ nhìn trong console
		...
		r = gin.New()                // create Router Instance without default middleware (bỏ chức debug log của chương trình) and you need to manually add any middleware you want to use.
	}
	// middleware
	r.Use() // Logging
	r.Use() // Cross
